...
\begin{itemize}
    ...
    \item Executa horários predefinidos ou cenas; por exemplo. ao pôr do sol acender as luzes do jardim.
\end{itemize}
...
\begin{description}
  ...
  \item[child-sensor-id] Cada nó pode ter varios sensores ligados, esse campo identifica qual é sensor “child” do nó;
  ...
  \item[sub-type] Dependendo messageType este campo tem um significado diferente.
